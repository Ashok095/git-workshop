...
> Issues define what is being built and why.
...
```
Add a testimonial section below the projects section
with a heading and placeholder text.
```
...
### Contributor: Create Feature Branch
...
### Contributor: Commit with Issue Reference
...
## Step 8: Opening a Pull Request (Contributor)
